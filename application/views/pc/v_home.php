        ...
        <div class="card shadow-5-strong rounded-8 wave wave-success total-users">
            <div class="card-body py-2">
                ...
                <div class="d-flex justify-content-between align-items-start mt-2">
                    <h2 class="text-dark fw-bold"><?=$dataUser[0]->USER_PC ?: '0'?></h2>
...
<div class="row mb-3">
  <div class="col-md-4">
    <div class="card">
      ...
      <div class="card-footer d-flex justify-content-between">
        <a class="text-center" href="<?=base_url()?>PC/viewComparation?tipe=AR">
            <h6 class="text-primary mb-0">Comparison Years</h6>
            <i class="fas fa-angle-down"></i>
        </a>
        <a class="text-center" href="<?=base_url()?>PC/viewList?tipe=AR">
  ...
  <div class="col-md-4">
    <div class="card">
      ...
      <div class="card-footer d-flex justify-content-between">
        <a class="text-center" href="<?=base_url()?>PC/viewComparation?tipe=KM">
            <h6 class="text-primary mb-0">Comparison Years</h6>
            <i class="fas fa-angle-down"></i>
        </a>
        <a class="text-center" href="<?=base_url()?>PC/viewList?tipe=KM">
            <h6 class="text-primary mb-0">See Detail</h6>
            <i class="fas fa-angle-down"></i>
        </a>
      </div>
  ...
  <div class="col-md-4">
    <div class="card">
      ...
      <div class="card-footer d-flex justify-content-between">
        <a class="text-center" href="<?=base_url()?>PC/viewComparation?tipe=MTBF">
            <h6 class="text-primary mb-0">Comparison Years</h6>
            <i class="fas fa-angle-down"></i>
        </a>
        <a class="text-center" href="<?=base_url()?>PC/viewList?tipe=MTBF">
            <h6 class="text-primary mb-0">See Detail</h6>
            <i class="fas fa-angle-down"></i>
        </a>
      </div>
